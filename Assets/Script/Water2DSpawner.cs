...
{
	public GameObject prefabWaterDrop;
	...
	/// </summary>
	[Range (-1f,100f)] public float LifeTime = 5f;
	...
	void Start()
	{
		var waterDropGameObject = Instantiate(prefabWaterDrop, transform.position, transform.rotation);
		waterDropGameObject.SetActive(false);
		WaterDropsObjects[0] = waterDropGameObject;
